...
export const BUILT_IN_PRESETS: PodcastPresetV1[] = [
  {
    ...
    ttsModel: "tts-1",
    targetMinutes: 6,
    speakers: [{ name: "Narrator", voice: "marin" }],
  ...
  },
  {
    ...
    podcastModel: "gpt-5.6-terra",
    ttsModel: "tts-1-hd",
    targetMinutes: 18,
    speakers: [
      { name: "Host", voice: "marin" },
      { name: "Expert", voice: "cedar" },
    ],
  ...
  },
  {
    ...
    targetMinutes: 30,
    speakers: [
      { name: "Moderator", voice: "alloy" },
      { name: "Analyst", voice: "coral" },
